...
from dolphin.libs.config_reader import get_local_layoutreader_model_dir, get_llm_aided_config, get_device
from magic_pdf.libs.convert_utils import dict_to_list
from magic_pdf.libs.hash_utils import compute_md5
from magic_pdf.libs.pdf_image_tools import cut_image_to_pil_image
from dolphin.model.magic_model import MagicModel
...
from dolphin.pre_proc.ocr_detect_all_bboxes import ocr_prepare_bboxes_for_layout_split_v2
from dolphin.pre_proc.ocr_dict_merge import fill_spans_in_blocks, fix_block_spans_v2, fix_discarded_block
...
def process_block_list(blocks, body_type, block_type):
    ...
    figure_desc = ''.join([block.get('figure_desc', '') for block in blocks if block.get('type') == body_type])
...
def parse_page_core(
    ...
    """获取所有line并对line排序"""
    if os.environ.get('METHOD_TYPE') == 'dolphin':
        sorted_bboxes = None
    else:
