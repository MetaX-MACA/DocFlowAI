...
from dolphin.tools.common import batch_do_parse, do_parse, parse_pdf_methods, parse_alg_methods
...
def cli(path, output_dir, method, lang, debug_able, start_page_id, end_page_id, alg_method_type, num_parrlel_inference,
        figure_vlm):
