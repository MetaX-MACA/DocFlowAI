...
class MagicModel:
            ...
            ret.append(
                {
                    'sub_bbox': {
                        ...
                        'figure_desc': subjects[i].get('figure_desc',""),
                    },
                    'obj_bboxes': [
    ...
    def __tie_up_category_by_distance_v3(
        ...
        subjects = self.__reduct_overlap(
            list(
                map(
                    lambda x: {'bbox': x['bbox'], 'score': x['score'], 'figure_desc': x.get('figure_desc','')},
                    filter(
                        lambda x: x['category_id'] == subject_category_id,
                        self.__model_list[page_no]['layout_dets'],
                    ),
            ...
            ret.append(
                {
                    'sub_bbox': {
                        ...
                        'figure_desc': subjects[sub_idx].get('figure_desc',""),
                    },
                    'obj_bboxes': [
            ...
            for k in range(len(subjects)):
                ...
                if k in seen_sub_idx:
                    ...
                    ret.append(
                        ...
                        'figure_desc': subjects[k].get('figure_desc',""),
                            },
                            'obj_bboxes': [
        ...
        for layout_det in layout_dets:
            ...
            if category_id in allow_category_id_list:
                ...
                if category_id == 3:
                    ...
                    span['figure_desc'] = layout_det.get('figure_desc', "")
                elif category_id == 5:
                    # 获取table模型结果
